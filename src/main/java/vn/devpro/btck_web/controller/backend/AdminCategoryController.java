...
import vn.devpro.btck_web.service.CategoryService;
...
public class AdminCategoryController extends BaseController {
	...
	public String categoryEdit(final Model model, @PathVariable("categoryId") int categoryId )//lay categoryId khi ngta click edit
		...
		public String categoryEditSave(final Model model, final HttpServletRequest request, @ModelAttribute("category") Category category) throws IOException {
