            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Order</h2>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="customerName" type="text" class="form-control" id="customerName" name="customerName" placeholder="customerName"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="customerMobile" type="text" class="form-control" id="customerMobile" name="customerMobile" placeholder="customerMobile"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="customerAddress" type="text" class="form-control" id="customerAddress" name="customerAddress" placeholder="customerAddress"></sf:input>
                                        		</div>
	                                    	</div>
	                                    	...
	                                    	<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="total" type="text" class="form-control" id="total" name="total" placeholder="total"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
